...
public class FileUploadUtil {
	...
	/*파일 업로드 메서드
	 * 파일명이 중복시 해결 방법
	 * System.currentTimeMillis() 를 사용하거나 UUID 128비트의 수이다.
	 * 표준 형식에서 UUID는 32개의 16진수로 표현되며 총 36개 문자(32개문자와 4개의 하이픈)로
	 * 된8-4-4-4-12라는 5개의 그룹을 하이폰으로 구분한다. 이를테면 다음과 같다
	 * 이떄 UUID.randomUUID().toString()를 이용해서 얻는다.
	 * 50e8400-e29b-a716-446655440000
	 * */
	...
	public static String makeThumnail(String fileName) throws Exception{
	      ...
	      //resize(대상[BufferedImage 타입], 원본 비율, 높이 또는 너비, 크기)
