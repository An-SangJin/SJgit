...
<html>
   <head>
       ...
       var max=0;
    	   ...
    	   if(Number(max)<Number(totsix)){
    		   max=totsix;
    	   }
    	   if(Number(max)<Number(totfiv)){
    		   max=totfiv;
    	   }
    	   if(Number(max)<Number(totfor)){
    		   max=totfor;
    	   }
    	   if(Number(max)<Number(totthr)){
    		   max=totthr;
    	   }   
    	   if(Number(max)<Number(tottwo)){
    		   max=tottwo;
    	   }  
    	   if(Number(max)<Number(totone)){
    		   max=totone;
    	   }
    	   if(Number(max)<Number(tot)){
    		   max=tot;
    	   }
