            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                 	   <h1 style="text-align: left;">신상품</h1><br/>            	
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="product-img">
                            <a href="/product/productDetail?p_num=${p_list.p_num}"><img style="height: 255px; width: 255px;" src="/uploadStorage/pImg/${p_list.p_img }" alt=""/></a>
                            <!-- Product Tag -->
