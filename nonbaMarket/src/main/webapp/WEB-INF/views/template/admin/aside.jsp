      ...
      <li class="nav-item">
        ...
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/adminMember/couponList">쿠폰 등록</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/adminNotice/notice">공지사항</a>
            <a class="collapse-item" href="/adminFaq/faq">자주하는 질문 게시판</a>
            <a class="collapse-item" href="/adminQna/qna">1대1 문의 게시판</a>
            <a class="collapse-item" href="/adminReview/review">후기 게시판</a>
            <a class="collapse-item" href="/adminProduct_inq/product_inq">상품문의 게시판</a>
          </div>
        </div>
      </li>
